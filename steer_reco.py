...
file_path = "/afs/hep.wisc.edu/home/kianian/future_collider/sim_output.slcio"
to_write = "/afs/hep.wisc.edu/home/kianian/future_collider"
...
if not the_args.enableBIB:
    Output_REC.Parameters = {
        ...
        "LCIOOutputFile": [to_write + "/reco_output.slcio"],
...
InitDD4hep.Parameters = {
        "DD4hepXMLFile": ["/afs/hep.wisc.edu/home/kianian/future_collider/detector-simulation/geometries/MAIA_v0/MAIA_v0.xml"],
...
CKFTracking.Parameters = {
    ...
    "CaloFace_Z": ["2307"],
    "MatFile": [os.environ["ACTS_MatFile_MAIA"]],
...
MyEcalBarrelSelector.Parameters = {
    ...
    "ThresholdsFilePath": ["/afs/hep.wisc.edu/home/kianian/future_collider/MyBIBUtils/data/ECAL_Thresholds_10TeV.root"],
    "Nsigma": ["0"],
...
#    "MuonEndCapBField": ["5.0"],
    ...
    "PandoraSettingsXmlFile": ["/afs/hep.wisc.edu/home/kianian/future_collider/SteeringMacros/PandoraSettings/PandoraSettingsDefault.xml"],
