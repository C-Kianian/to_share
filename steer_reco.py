...
file_path = "/afs/hep.wisc.edu/home/kianian/future_collider"
in_file = "/afs/hep.wisc.edu/home/kianian/future_collider/sim_output.slcio"
...
MyAIDAProcessor.Parameters = {
    "FileName": [file_path + "/digi_reco_output"],
    "FileType": ["root"]
}
...
if not the_args.enableBIB:
    Output_REC.Parameters = {
        ...
        "LCIOOutputFile": [file_path + "/digi_reco_output.slcio"],
    ...
    Output_REC.Parameters = {
        ...
        "LCIOOutputFile": [file_path + "/digi_reco_BIB_output.slcio"],
        "LCIOWriteMode": ["WRITE_NEW"]
    }
...
InitDD4hep.Parameters = {
    "DD4hepXMLFile": [file_path + "/detector-simulation/geometries/MAIA_v0/MAIA_v0.xml"],
...
MyEcalBarrelSelector.Parameters = {
    ...
    "ThresholdsFilePath": [file_path + "/MyBIBUtils/data/ECAL_Thresholds_10TeV.root"],
    "Nsigma": ["0"],
...
#    "MuonEndCapBField": ["5.0"],
    ...
    "PandoraSettingsXmlFile": [file_path + "/SteeringMacros/PandoraSettings/PandoraSettingsDefault.xml"],
